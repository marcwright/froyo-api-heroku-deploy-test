var yogurtApp = angular.module('yogurt-app', ['ngResource', 'mgcrea.ngStrap', 'ngAnimate']).config(
...
yogurtApp.controller('YogurtCtrl', ['$scope', 'Yogurt', '$modal', function($scope, Yogurt, modal) {
    $scope.yogurts= [];
